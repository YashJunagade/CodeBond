...
const DailyQuestion = ({ question }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute top-0 right-0 w-32 h-32 bg-gradient-to-bl from-blue-100 to-transparent dark:from-blue-900/20 rounded-full -mr-16 -mt-16 transition-transform duration-500 ${isHovered ? 'scale-110' : 'scale-100'}`}
      ></div>
